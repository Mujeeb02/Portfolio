    ...
    >
      <div className="h-full flex flex-col lg:flex-row px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48">
        ...
        <div className="pt-[40%] md:pt-[15%] lg:pt-[3%] lg:pl-8 h-1/2 lg:h-full lg:w-1/2 flex flex-col gap-8 items-center justify-center">
          ...
          {/* DESC */}
          <p className="text-lg md:text-xl text-gray-700 mt-4">a software engineer and full stack developer. I turn ideas into seamless digital experiences, blending creativity and technical expertise. Let's build a more connected and vibrant digital world together.
          </p>
